window.CHARTS = [
  {id:"SURFACE",mode:"analysis",group:"地上",name:"地上天気図（日本周辺カラー）",source:"surface",validHours:[0,3,6,9,12,15,18,21]},
  {id:"HIMAWARI_VIS",mode:"analysis",group:"ひまわり",name:"可視画像（日本域）",source:"satellite",satelliteType:"visible",validHours:[0,3,6,9,12,15,18,21]},
  {id:"HIMAWARI_IR",mode:"analysis",group:"ひまわり",name:"赤外画像（日本域）",source:"satellite",satelliteType:"infrared",validHours:[0,3,6,9,12,15,18,21]},
  {id:"HIMAWARI_WV",mode:"analysis",group:"ひまわり",name:"水蒸気画像（日本域）",source:"satellite",satelliteType:"watervapor",validHours:[0,3,6,9,12,15,18,21]},
  ...
  {id:"AXJP130",mode:"analysis",group:"高層断面図",name:"高層断面図 東経130度",source:"sunny",validHours:[0,12]},
  {id:"AXJP140",mode:"analysis",group:"高層断面図",name:"高層断面図 東経140度",source:"sunny",validHours:[0,12]},

  {id:"FXJP854_ANALYSIS",sourceCode:"FXJP854",mode:"analysis",group:"特殊",name:"日本850hPa相当温位・風（T−12h初期の+12hパネルを実況用に使用）",source:"sunny",validHours:[0,12],initOffsetHours:-12,containedForecastHours:[12,24,36,48]},
  ...
  {id:"FEAS504",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[48]},
  {id:"FEAS507",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[72]},
  {id:"FEAS509",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[96]},
  {id:"FEAS512",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[120]},
  {id:"FEAS514",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[144]},
  {id:"FEAS516",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[168]},
  {id:"FEAS519",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[192]},
  {id:"FEAS521",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[216]},
  {id:"FEAS524",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[240]},
  {id:"FEAS526",mode:"forecast",group:"アジア予想図",name:"同上",source:"sunny",validHours:[12],containedForecastHours:[264]},

  {id:"FXJP854",mode:"forecast",group:"日本予想図",name:"日本850hPa相当温位・風（+12/+24/+36/+48hを1枚に収録）",source:"sunny",validHours:[0,12],containedForecastHours:[12,24,36,48]}
];
