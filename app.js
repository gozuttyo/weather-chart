...
listEl.addEventListener("change",renderPlan); dateEl.addEventListener("change",renderPlan); hourEl.addEventListener("change",renderCharts); modeEl.addEventListener("change",renderCharts); $("#build").addEventListener("click",build); renderCharts();
